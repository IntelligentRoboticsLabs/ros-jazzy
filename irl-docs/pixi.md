...
- Building ROS 2 jazzy packages as `.conda` artifacts
...
- **Channels**: conda package sources used by the solver.
  - In this repo we commonly use:
    ...
    - A local file-based channel: `file:///.../ros-jazzy/output`
...
- Correct: `file:///.../ros-jazzy/output`
- Incorrect: `file:///.../ros-jazzy/output/linux-64`
...
- `pixi run -m /path/to/ros-jazzy plansys2-all`
